...
//   currentUser = { id: 37 }; // Example current user ID
//   showChat = false;
//   selectedUser: { userId: number, userAvatar: string, firstname: string, lastname: string } | null = null;
...
//   openChat(user: { userId: number, userAvatar: string, firstname: string, lastname: string }): void {
